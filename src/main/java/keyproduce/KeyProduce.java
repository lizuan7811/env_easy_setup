...
//		X509v3CertificateBuilder certGen = new X509v3CertificateBuilder(X500Name.getInstance(null), BigInteger.TEN,
//				new Date(), new Date(System.currentTimeMillis() + 100 * 24 * 60 * 60 * 1000),
//				X500Name.getInstance(null), SubjectPublicKeyInfo.getInstance(null));
...
//		final AlgorithmIdentifier sigAlgId = new DefaultSignatureAlgorithmIdentifierFinder().find("SHA512WITHRSA");
//		final AlgorithmIdentifier digAlgId = new DefaultDigestAlgorithmIdentifierFinder().find("SHA512");
//
